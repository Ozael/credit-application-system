...
class CustomerResourceTest {
  ...
  fun `should find customer by id and return 200 status`() {
    ...
    mockMvc.perform(
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Ozael"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Filho"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("12345678900"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("ozael@email.com"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua do Ozael, 123"))
      //.andExpect(MockMvcResultMatchers.jsonPath("$.id").value(1))
      .andDo(MockMvcResultHandlers.print())
  }
  ...
  fun `should update a customer and return 200 status`() {
    ...
    mockMvc.perform(
      ...
      .andExpect(MockMvcResultMatchers.status().isOk)
      .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("OzaelUpdate"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("FilhoUpdate"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("12345678900"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("ozael@email.com"))
  ...
  private fun builderCustomerDto(
    firstName: String = "Ozael",
    lastName: String = "Filho",
    cpf: String = "12345678900",
    email: String = "ozael@email.com",
    income: BigDecimal = BigDecimal.valueOf(1000.0),
    password: String = "1234",
    zipCode: String = "000000",
    street: String = "Rua do Ozael, 123",
  ) = CustomerDto(
    firstName = firstName,
    lastName = lastName,
    cpf = cpf,
  ...
  private fun builderCustomerUpdateDto(
    firstName: String = "OzaelUpdate",
    lastName: String = "FilhoUpdate",
